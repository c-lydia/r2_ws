...
Release notes: see the [CHANGELOG.md](CHANGELOG.md) for full details. Detailed system architecture is in [docs/system_architecture.md](docs/system_architecture.md).
